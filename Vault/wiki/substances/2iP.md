...
## Механизм действия
Mild growth promoter

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Weak cytokinin activity | Apply 25-75 ppm foliar spray | Mild cytokinin effects, stress tolerance | MEDIUM | Specialty applications, research |
