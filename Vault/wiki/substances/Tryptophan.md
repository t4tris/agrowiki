...
application_csv: Apply 100-500 ppm as root drench
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Auxin precursor | Apply 100-500 ppm as root drench | Natural auxin production enhancement | MEDIUM | Rooting applications, transplants |
