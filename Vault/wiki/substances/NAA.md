...
type: substance
code: NAA
name_en: Naphthaleneacetic Acid
cas: 
formula: 
...
## Механизм действия
Fruit set/growth promoter

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Fruit growth | Apply 30-400 ppm | Reduced fruit drop, enlarged receptacle, delayed ripening — 40 ppm accelerates flowering by stimulating florigen production — 19.97 mg/l , 30-60-75-100-150-300ppm, The plant growth regulators were applied on the 30th and 45th days after planting on strawberry — reducing fruit drop spraying strawberry cv. with 400 ppm NAA resulted in the greatest natural product width, weightenlargement of receptacle, fruit size growth and delay fruit ripening | MEDIUM | Strawberry, fruit crops |
