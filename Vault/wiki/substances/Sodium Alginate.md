---
type: substance
code: Sodium Alginate
name_en: Alginate oligosaccharide
cas: 
formula: 
class: Biostimulant
...
# Sodium Alginate — Alginate oligosaccharide
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Polysaccharide elicitor | fruit sprayed 0.5% w/v | Enhanced disease resistance, fruit firmness with melatonin | MEDIUM | High-value crops |
