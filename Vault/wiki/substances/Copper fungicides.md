---
type: substance
code: Copper fungicides
name_en: Copper-based fungicides
cas: 
formula: 
...
application_csv: Apply 1-3 kg/ha foliar spray
efficacy_csv: LOW
...
# Copper fungicides — Copper-based fungicides
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Broad-spectrum protection | Apply 1-3 kg/ha foliar spray | Disease control + minimal PGR | LOW | Organic systems |
