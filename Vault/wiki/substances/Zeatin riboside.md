---
type: substance
code: Zeatin riboside
name_en: Zeatin riboside
cas: 
formula: 
class: Cytokinin
...
# Zeatin riboside — Zeatin riboside
...
## Механизм действия
Mobile cytokinin form

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Cell division enhancement | Apply 10-30 ppm foliar spray | Enhanced cell division and shoot growth | MEDIUM | Young plants, tissue culture |
