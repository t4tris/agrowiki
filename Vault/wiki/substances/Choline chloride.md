...
|---|---|---|---|---|---|
| SEED_TREATMENT | Stress reducer & osmoprotection | Apply 50-200 ppm seed priming | Improved germination under stress | MEDIUM | All crop seeds |
