...
## Механизм действия
Respiration inhibitor + ethylene suppression

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Greening effect | Apply 100-200 g/ha as per label | Disease control + delayed senescence | HIGH | All crops with fungicide programs |
