---
type: substance
code: Sodium ortho-nitrophenolate
name_en: Sodium ortho-nitrophenolate
cas: 
formula: 
...
# Sodium ortho-nitrophenolate — Sodium ortho-nitrophenolate
...
## Механизм действия
Auxin-like biostimulant

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| SEED_TREATMENT | — | Apply 50-200 ppm seed soak | Stimulated root growth and stress tolerance | MEDIUM | All crop seeds |
