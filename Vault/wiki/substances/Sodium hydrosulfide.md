---
type: substance
code: Sodium hydrosulfide
name_en: Sodium hydrosulfide (NaHS)
cas: 
formula: 
class: Sulfide salt
...
# Sodium hydrosulfide — Sodium hydrosulfide (NaHS)
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | H2S donor | Foliar application | H2S-mediated stress tolerance and ripening signaling | LOW | Fruit crops |
