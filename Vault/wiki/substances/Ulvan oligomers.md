---
type: substance
code: Ulvan oligomers
name_en: Ulvan oligosaccharides
cas: 
formula: 
...
application_csv: Apply 0.5-2 L/ha foliar spray
efficacy_csv: MEDIUM
...
# Ulvan oligomers — Ulvan oligosaccharides
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Defense signaling & root growth | Apply 0.5-2 L/ha foliar spray | Improved root and shoot biomass | MEDIUM | All crops |
