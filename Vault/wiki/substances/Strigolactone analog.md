...
application_csv: Apply 1-10 ppm soil drench
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Branching inhibition | Apply 1-10 ppm soil drench | Controlled shoot branching, enhanced root growth | MEDIUM | Research applications, specialty crops |
