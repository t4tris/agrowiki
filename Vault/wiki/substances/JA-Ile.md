...
type: substance
code: JA-Ile
name_en: Jasmonic acid-isoleucine
cas: 
formula: 
class: Jasmonate
...
application_csv: Apply 25-100 ppm foliar spray
efficacy_csv: MEDIUM
...
## Механизм действия
Storage protein inducer

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Protein storage enhancement | Apply 25-100 ppm foliar spray | Enhanced protein accumulation, seed quality | MEDIUM | Legumes, protein crops |
