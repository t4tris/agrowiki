...
application_csv: Apply 1-10 ppm seed treatment
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| SEED_TREATMENT | Smoke response | Apply 1-10 ppm seed treatment | Enhanced germination response to smoke signals | MEDIUM | Fire-adapted species, native plants |
