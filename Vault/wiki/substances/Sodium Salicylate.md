...
application_csv: Apply 0.5-2 mM foliar spray
efficacy_csv: MEDIUM
...
## Механизм действия
Defense activator & stress tolerance

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 0.5-2 mM foliar spray | Enhanced disease resistance and antioxidant enzyme activity | MEDIUM | Tomato, cucumber |
