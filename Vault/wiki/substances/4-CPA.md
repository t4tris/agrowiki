...
type: substance
code: 4-CPA
name_en: 4-Chlorophenoxyacetic Acid
cas: 
formula: 
class: Auxin
...
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Fruit set | Apply 10-50 ppm spray during flowering | Improved fruit set and reduced drop | HIGH | Tomatoes, beans, citrus |
