---
type: substance
code: Metal nanoparticles (ZnO, FeO, CuO, Se, TiO2, Ag, CeO2)
name_en: Nanoparticles
cas: 
formula: 
class: Metal / metal-oxide nanoparticles
...
# Metal nanoparticles (ZnO, FeO, CuO, Se, TiO2, Ag, CeO2) — Nanoparticles
...
## Механизм действия
Nano-priming, ROS signaling, micronutrient delivery

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Nano-stimulation | Foliar spray or seed treatment (low ppm) | Enhanced germination, growth and stress tolerance via nano-scale delivery | MEDIUM | Cereals, vegetables, fruit crops |
