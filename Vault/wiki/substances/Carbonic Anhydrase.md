---
type: substance
code: Carbonic Anhydrase
name_en: Zn-containing enzyme
cas: 
formula: 
class: Enzyme
...
# Carbonic Anhydrase — Zn-containing enzyme
...
|---|---|---|---|---|---|
| PHOTOSYNTHESIS_ENHANCEMENT | Carbon fixation | Apply Zn foliar 0.5-1% | Enhanced CO2 assimilation | MEDIUM | All crops |
