---
type: substance
code: Sodium 2-nitrophenolate
name_en: Sodium 2-nitrophenolate
cas: 
formula: 
...
# Sodium 2-nitrophenolate — Sodium 2-nitrophenolate
...
|---|---|---|---|---|---|
| SEED_TREATMENT | — | Apply 50-200 ppm seed soak | Improved seedling vigor | MEDIUM | All crops |
