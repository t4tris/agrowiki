---
type: substance
code: Kresoxim-methyl
name_en: Kresoxim-methyl
cas: 
formula: 
...
application_csv: Apply 75-150 g/ha foliar spray
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Photosynthesis enhancer | Apply 75-150 g/ha foliar spray | Improved yield and greening effect | MEDIUM | All crops |
