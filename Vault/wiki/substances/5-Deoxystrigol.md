...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Root architecture modifier | Apply 0.1-1 ppm soil drench | Modified root architecture, enhanced uptake | LOW | Research applications, root studies |
