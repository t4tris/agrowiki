---
type: substance
code: Sodium nitroprusside
name_en: Sodium nitroprusside (SNP)
cas: 
formula: 
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | NO donor | Foliar application | NO-mediated stress tolerance and ripening signaling | LOW | Fruit crops |
