...
phi_mrl:
  ...
  source: "EU Pesticides Database v3.4 (Reg. (EU) 2023/1719, Annex II); Codex — MRL не установлены (нет в списке пестицидов); статус ЕС: Approved до 31/01/2029"
  notes: "MRL EU 0.01 mg/kg = предел определения (LOD) для томата/огурца/клубники; PHI на уровне ЕС не устанавливается (национальные авторизации); клип: raw/sources/Paclobutrazol/eu_mrl_codex_2026-08-04.md"
---
...
## 📅 PHI и MRL
**Данные получены (2026-08-04, EU Pesticides Database + Codex, см. [клип](../../../raw/sources/Paclobutrazol/eu_mrl_codex_2026-08-04.md)).**
...
| **MRL Codex** | **не установлен** (PBZ отсутствует в списке пестицидов Codex, 240 записей) |
| MRL USA | не проверялся (eCFR API недоступен) |
| **Статус ЕС** | **Approved**, срок одобрения до **31/01/2029** |
| **PHI** | на уровне ЕС не устанавливается (национальные авторизации государств-членов) |

⚠️ Практический вывод: MRL на уровне LOD (0.01 mg/kg) для томата/огурца/клубники — применение
PBZ на этих культурах в ЕС предполагает отсутствие остатков выше порога обнаружения;
для экспорта в ЕС обязательна проверка по действующему регламенту. США — дополнительно eCFR 40 CFR 180.
