...
## 📅 PHI и MRL
**PHI/REI:** устанавливаются этикеткой конкретного препарата (напр., Bonzi, Cultar) или
национальной авторизацией (e-phy FR, BVL DE, EPA); в открытых БД (EUPD/PPDB/Codex) не публикуются.
