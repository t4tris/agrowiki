---
type: substance
code: Chitosan nanoparticles
name_en: Chitosan nanoparticles
cas: 
formula: 
class: Biostimulant
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Stress tolerance & growth stimulation | Apply 50-200 ppm foliar spray | Enhanced stress tolerance and growth | LOW | Research applications |
