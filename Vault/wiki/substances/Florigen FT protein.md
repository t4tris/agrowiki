---
type: substance
code: Florigen FT protein
name_en: Florigen FT protein
cas: 
formula: 
class: Peptide
...
# Florigen FT protein — Florigen FT protein
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Flowering signal | Apply 1-10 ppm foliar spray | Induced reproductive transition | LOW | Grafting studies |
