---
type: substance
code: Chelated titanium
name_en: Chelated titanium
cas: 
formula: 
class: Biostimulant
...
# Chelated titanium — Chelated titanium
...
## Механизм действия
Photosynthesis stimulator

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| SOIL_APPLICATION | Foliar & soil conditioner | Apply 0.5-2 kg/ha with fertilizer | Enhanced chlorophyll content and photosynthesis | LOW | Research use |
