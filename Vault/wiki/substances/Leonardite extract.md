---
type: substance
code: Leonardite extract
name_en: Humic substances
cas: 
formula: 
...
# Leonardite extract — Humic substances
...
|---|---|---|---|---|---|
| SOIL_APPLICATION | Root development + nutrient chelation | Apply 5-20 kg/ha soil incorporation | Enhanced root growth and nutrient uptake | HIGH | All crops, especially poor soils |
