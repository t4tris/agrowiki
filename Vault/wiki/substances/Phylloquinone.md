...
# Phylloquinone — Phylloquinone (K1)
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 5-20 ppm foliar spray | Improved photosynthetic electron flow | LOW | Research applications |
