...
# Polyglutamic acid — Polyglutamic acid (³-PGA)
...
|---|---|---|---|---|---|
| SOIL_APPLICATION | Fertilizer efficiency enhancer | Apply 1-5 L/ha with fertilizer | Improved fertilizer uptake efficiency | HIGH | All crops |
