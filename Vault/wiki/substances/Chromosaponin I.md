---
type: substance
code: Chromosaponin I
name_en: Chromosaponin I
cas: 
formula: 
class: Saponin
...
application_csv: Apply 0.1-0.2% soil drench
efficacy_csv: MEDIUM
...
# Chromosaponin I — Chromosaponin I
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 0.1-0.2% soil drench | Increased root hair density and nutrient uptake | MEDIUM | Lettuce, Arabidopsis |
