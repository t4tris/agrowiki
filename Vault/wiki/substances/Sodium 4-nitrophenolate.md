---
type: substance
code: Sodium 4-nitrophenolate
name_en: Sodium 4-nitrophenolate
cas: 
formula: 
...
application_csv: Apply 50-200 ppm seed treatment
efficacy_csv: MEDIUM
...
# Sodium 4-nitrophenolate — Sodium 4-nitrophenolate
...
|---|---|---|---|---|---|
| SEED_TREATMENT | — | Apply 50-200 ppm seed treatment | Enhanced drought tolerance | MEDIUM | Stress-prone crops |
