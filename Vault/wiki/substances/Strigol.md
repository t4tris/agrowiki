...
application_csv: Apply 0.1-1 ppm soil drench
efficacy_csv: MEDIUM
...
## Механизм действия
Root development signal

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Natural strigolactone | Apply 0.1-1 ppm soil drench | Enhanced root development, reduced branching | MEDIUM | Research applications, specialty crops |
