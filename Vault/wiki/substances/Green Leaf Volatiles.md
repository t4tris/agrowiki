---
type: substance
code: Green Leaf Volatiles
name_en: Z-3-hexenol/hexenal
cas: 
formula: 
...
# Green Leaf Volatiles — Z-3-hexenol/hexenal
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Defense priming | Apply 10-50 ppm foliar spray | Primed defense responses | MEDIUM | Integrated pest management |
