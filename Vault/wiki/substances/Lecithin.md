...
application_csv: Apply 0.2% foliar spray
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 0.2% foliar spray | Reduced pathogen infection and improved spray retention | MEDIUM | All crops |
