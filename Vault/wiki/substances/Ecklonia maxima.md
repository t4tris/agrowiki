---
type: substance
code: Ecklonia maxima
name_en: Ecklonia maxima extract
cas: 
formula: 
class: Biostimulant
...
# Ecklonia maxima — Ecklonia maxima extract
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Cytokinin-like activity | Apply 2-5 L/ha foliar spray | Enhanced shoot growth and stress tolerance | MEDIUM | All crops |
