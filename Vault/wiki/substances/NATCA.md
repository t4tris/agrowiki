...
type: substance
code: NATCA
name_en: N-Acetyl-thiazolidine-4-carboxylic Acid
cas: 
formula: 
class: Biostimulant
...
## Механизм действия
Stress tolerance & rooting enhancement

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| SEED_TREATMENT | Stress reducer & rooting enhancer | Apply 100-300 ppm seed soak for 4-6 hours | Improved root development and stress tolerance | MEDIUM | Seedlings, transplants |
