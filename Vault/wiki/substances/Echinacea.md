...
type: substance
code: Echinacea
name_en: Purple coneflower extract
cas: 
formula: 
class: Polyphenol
...
# Echinacea — Purple coneflower extract
...
## Механизм действия
Antioxidant defense & elicitor

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 100-500 ppm foliar spray | Enhanced stress tolerance and defense | MEDIUM | Tomato, lettuce |
