...
## Механизм действия
Stress signal molecule

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Stress signaling | 10 mM | Enhanced stress tolerance, fruit color, weight and firmness; reduced decay during storage | MEDIUM | reharvest GABA Application Most effective at the red-turning stage.Improved fruit color, weight, firmness, SSC, and levels of citric acid, vitamin C, and soluble sugars. Postharvest GABA Treatment Delayed the decline of organic acids, sugars, firmness, color, and SSC. Reduced decay incidence and weight loss during storage. — Strawberry, tomato, fruit crops |
