---
type: substance
code: N-acetylglucosamine
name_en: N-acetylglucosamine
cas: 
formula: 
class: Biostimulant
...
application_csv: Apply 1-5 kg/ha soil incorporation
efficacy_csv: MEDIUM
...
## Механизм действия
Microbial activity enhancer

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| SOIL_APPLICATION | Soil microbial enhancer | Apply 1-5 kg/ha soil incorporation | Increased beneficial microbial populations | MEDIUM | Organic farming systems |
