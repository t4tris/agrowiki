---
type: substance
code: HypSys peptides
name_en: HypSys peptides
cas: 
formula: 
class: Peptide
...
# HypSys peptides — HypSys peptides
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Defense signaling | Apply 1-10 ppm foliar spray | Induced defense genes | LOW | Solanaceae research |
