---
type: substance
code: Sargassum extracts
name_en: Sargassum extract
cas: 
formula: 
class: Biostimulant
...
# Sargassum extracts — Sargassum extract
...
## Механизм действия
Nutrient chelation & hormesis

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Marine biostimulant | Apply 2-5 L/ha foliar spray | Improved nutrient uptake and yield | MEDIUM | All crops |
