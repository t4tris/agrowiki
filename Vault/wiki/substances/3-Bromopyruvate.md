---
type: substance
code: 3-Bromopyruvate
name_en: 3-Bromopyruvate (3-BrPA)
cas: 
formula: 
...
# 3-Bromopyruvate — 3-Bromopyruvate (3-BrPA)
...
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Ripening promotion | Spray fruit 5 mM | Accelerated ripening — fruits sprayed 5 mM — faster ripening | LOW | Strawberry, fruits |
