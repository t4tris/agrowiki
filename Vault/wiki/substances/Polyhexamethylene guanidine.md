---
type: substance
code: Polyhexamethylene guanidine
name_en: Polyhexamethylene guanidine (PHMG)
cas: 
formula: 
...
# Polyhexamethylene guanidine — Polyhexamethylene guanidine (PHMG)
...
## Механизм действия
Hormone-like growth regulation

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Hormone-like biostimulant | Foliar application | Hormone-like action; growth regulation and disease protection | LOW | Various crops |
