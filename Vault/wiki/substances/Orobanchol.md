...
application_csv: Apply 0.1-1 ppm soil application
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Branching inhibitor | Apply 0.1-1 ppm soil application | Reduced lateral branching, enhanced main stem | MEDIUM | Research applications, plant architecture |
