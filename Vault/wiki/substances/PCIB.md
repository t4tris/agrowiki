...
type: substance
code: PCIB
name_en: p-Chlorophenoxyisobutyric acid
cas: 
formula: 
class: Aryloxy acid
class_family: auxins
...
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Auxin inhibition | 100 µg in 40 µL ethanol | Accelerated strawberry fruit coloration — 100 µg in 40 µl of ethanol — accelerates strawberry fruit coloration | LOW | Strawberry, fruits |
