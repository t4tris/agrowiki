...
application_csv: Apply 5-20 ppm seed treatment
efficacy_csv: LOW
...
|---|---|---|---|---|---|
| SEED_TREATMENT | Stress tolerance enhancer | Apply 5-20 ppm seed treatment | Enhanced stress tolerance | LOW | — |
