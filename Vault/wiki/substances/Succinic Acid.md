...
application_csv: Apply 100-500 ppm soil drench
efficacy_csv: MEDIUM
...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Mycorrhizal activity | Apply 100-500 ppm soil drench | Improved root metabolism and microbial activity | MEDIUM | Perennial crops, trees |
