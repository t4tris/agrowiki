...
type: substance
code: TIBA
name_en: 2,3,5-Triiodobenzoic acid
cas: 
formula: 
...
## Механизм действия
Gravitropic response modifier

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Auxin transport inhibition | Apply 10-50 ppm as research tool | Modified root/shoot development responses | LOW | Research applications, plant studies |
