---
type: substance
code: Hydroxycinnamic Acids
name_en: Hydroxycinnamic Acids
cas: 
formula: 
class: Phenolic
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 50–200 ppm foliar spray | Enhanced phenylpropanoid metabolism and stress tolerance | MEDIUM | All crops |
