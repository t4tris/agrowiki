---
type: substance
code: 14-Hydroxylated brassinosteroid
name_en: 14-Hydroxylated brassinosteroid
cas: 
formula: 
...
# 14-Hydroxylated brassinosteroid — 14-Hydroxylated brassinosteroid
...
|---|---|---|---|---|---|
| GROWTH_REGULATION | Morphogenesis control | Apply 0.1-0.5 ppm foliar spray | Controlled plant morphogenesis | LOW | Research applications, specialty uses |
