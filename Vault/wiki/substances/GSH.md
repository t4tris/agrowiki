...
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Ripening delay | Fruit injection 0.5 mL of 100 mM | Delayed ripening via reduced H2O2 — fruits at the de-greening stage (DG, 18 days after anthesis) were injected with 0.5 mL 100 mM GSH solution until drip ping — lower endogenous H2O2 levels caused by reduced glutathione (GSH) treatment resulted in a transient increase in glycolysis while delaying strawberry fruit ripening. | MEDIUM | Strawberry, fruits |
