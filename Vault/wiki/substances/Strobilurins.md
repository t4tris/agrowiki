...
|---|---|---|---|---|---|
| PHOTOSYNTHESIS_ENHANCEMENT | Light utilization | Apply as per label for disease control | Improved photosynthetic efficiency | MEDIUM | All crops with fungicide program |
