...
|---|---|---|---|---|---|
| SEED_TREATMENT | Disease protection | Apply 50-200 ppm in seed treatment solution | Improved stress tolerance and disease resistance | MEDIUM | Cereal crops, legumes |
