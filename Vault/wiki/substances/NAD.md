...
## Механизм действия
Selective thinning agent

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Fruit thinning | Apply 15-30 ppm spray post fruit set | Selective fruit drop, improved fruit quality | HIGH | Stone fruits, citrus |
