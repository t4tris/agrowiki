---
type: substance
code: Protocatechuic acid
name_en: Protocatechuic acid
cas: 
formula: 
class: Phenolic
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | — | Apply 50-200 ppm foliar spray | Improved oxidative stress tolerance | LOW | Research use |
