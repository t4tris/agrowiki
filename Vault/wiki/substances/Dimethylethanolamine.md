---
type: substance
code: Dimethylethanolamine
name_en: Dimethylethanolamine
cas: 
formula: 
class: Biostimulant
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Metabolite precursor stimulator | Apply 25-100 ppm foliar spray | Enhanced growth rate and biomass | LOW | Experimental use |
