...
type: substance
code: NPA
name_en: N-Phenylphthalamic acid
cas: 
formula: 
...
|---|---|---|---|---|---|
| ROOT_DEVELOPMENT | Polar auxin transport blocking | Apply 1-10 ppm research treatment | Blocked auxin transport, modified development | LOW | Research applications only |
