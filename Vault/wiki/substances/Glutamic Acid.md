...
## Механизм действия
N metabolism enhancer

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Nitrogen metabolism | Apply 200-1000 ppm foliar spray | Enhanced nitrogen utilization | MEDIUM | All crops, especially during N stress |
