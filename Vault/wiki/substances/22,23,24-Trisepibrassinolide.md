---
type: substance
code: 22,23,24-Trisepibrassinolide
name_en: 22,23,24-Trisepibrassinolide
cas: 
formula: 
...
application_csv: Apply 0.05-0.5 ppm foliar spray
efficacy_csv: MEDIUM
...
# 22,23,24-Trisepibrassinolide — 22,23,24-Trisepibrassinolide
...
## Механизм действия
Multi-stress protector

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Enhanced stress tolerance | Apply 0.05-0.5 ppm foliar spray | Enhanced tolerance to multiple stresses | MEDIUM | Crops under various stress conditions |
