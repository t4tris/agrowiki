...
## Идентичность
- **CAS:** не установлен (олигомерная смесь)
...
Литература охватывает методы: фолиарная обработка (проростки, теплица), in vitro и in vivo антифунгальные тесты.
...
**Нет данных** о применении COS на клубнике; данные по полимерному хитозану — см. [[Chitosan]].

## ⚠️ Валидация CSV-заявок
| CSV-заявка | Вердикт | Уточнение | Условия | Severity | Источники |
|---|---|---|---|---|---|
| Способ: заделка в почву 1–5 кг/га; эффект: микробная активность почвы | ⚪ Нет данных | Применение COS в литературе — только фолиарное и антифунгальное (огурец, томат); заявка аннотациями не покрыта (см. [[Chitosan]]) | — | — | — |
