...
application_csv: Apply 1-10 ppm foliar (research stage)
efficacy_csv: LOW
...
# CLE peptides — CLAVATA3/ESR peptides
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Meristem maintenance | Apply 1-10 ppm foliar (research stage) | Controlled meristem activity | LOW | Research applications only |
