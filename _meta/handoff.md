...
**Конвейер работает и прошёл 5 циклов внешнего аудита** (ревью 2026-08-06 part 3, оценка 7/10 —
реализовано в тот же день: контракт v1.5, восстановление Figueiredo 2015). Контракт — **v1.5**
(source_type: pmid|doi|openalex|isbn|url_verified|label); стиль-гайд карточек **v2.3** «конечные
факты»; все 21 валидированная карточка на новой схеме (эталон — IBA.md). Валидировано
**10 новых HIGH-веществ** (11 → 21), добавлены 2 rev2-артефакта, расширен smoke_test (правило 10),
