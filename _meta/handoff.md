...
| `_scripts/gen_taxonomy.py` | Таксономия (8 категорий + 24 семейства + 15 механизмов); `--refresh` для пересчёта |
...
- Таксономия: 8 категорий + 24 семейства + 15 механизмов (267 карточек с `class_family`/`mechanism`)
