...
## Механизм действия
Vascular development enhancer

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Vascular differentiation | Apply 0.1-1 ppm foliar spray | Enhanced vascular development and strength | MEDIUM | Young plants, tree seedlings |
