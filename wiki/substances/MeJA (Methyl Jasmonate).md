---
type: substance
code: MeJA (Methyl Jasmonate)
name_en: Methyl Jasmonate (MeJA)
cas: 
formula: 
class: Jasmonate
...
# MeJA (Methyl Jasmonate) — Methyl Jasmonate (MeJA)
...
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Ripening & shelf-life | Fruit spray 230 µM | Prolonged strawberry shelf life; promotes maturation and stress tolerance — 230 µM — shelf life of strawberries harvested after MeJA treatment is prolonged | MEDIUM | Strawberry, fruits |
