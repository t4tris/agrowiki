---
type: substance
code: CLE RALF CEP PSK peptides
name_en: CLE/RALF/CEP/PSK peptides
cas: 
formula: 
class: Peptide
...
# CLE RALF CEP PSK peptides — CLE/RALF/CEP/PSK peptides
...
|---|---|---|---|---|---|
| FOLIAR_APPLICATION | Root-shoot signaling | Apply 1-10 ppm foliar spray | Modulated growth responses | LOW | Experimental |
