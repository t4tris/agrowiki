...
## Механизм действия
Cell division promoter

## Применение (CSV)
| Категория | Действие | Дозировка/Способ | Ожидаемый результат | Эффективность | Культуры |
|---|---|---|---|---|---|
| FRUIT_MANAGEMENT | Fruit size | Apply 10-50 ppm foliar | Increased fruit weight, length and retention — 10-50ppm foliar spray sprayed mango trees at 14 days after blooming which results that CPPU at 10 ppm, gave the best result in increasing fruit retention, number of fruit per cluster, fruit weight, volume and leaf area — ncreased fruit weight, length, and diamete | MEDIUM | Mango, strawberry, fruits |
